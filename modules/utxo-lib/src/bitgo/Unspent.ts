 ...
 */
export function toOutput<TNumber extends number | bigint = number>(
  u: Unspent<TNumber>,
  network: Network
): TxOutput<TNumber> {
  return {
 ...
 */
export function toPrevOutput<TNumber extends number | bigint = number>(
  u: Unspent<TNumber>,
  network: Network
): PrevOutput<TNumber> {
  return {
 ...
 */
export function addToTransactionBuilder<TNumber extends number | bigint = number>(
...
export function unspentSum<TNumber extends number | bigint = number>(
