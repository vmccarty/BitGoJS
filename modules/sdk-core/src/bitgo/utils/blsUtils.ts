...
export class BlsUtils extends MpcUtils implements IBlsUtils {
  ...
  async createUserKeychain(
    ...
    const userSigningMaterial: SigningMaterial = {
      userShare: {
        ...
        secretShare: userKeyShare.secretShares[0],
        seed: userKeyShare.seed,
        chaincode: userKeyShare.chaincode,
      },
      backupShare: {
        publicShare: backupKeyShare.pub,
        secretShare: backupKeyShare.secretShares[0],
        chaincode: backupKeyShare.chaincode,
      },
      bitgoShare: {
        publicShare: bitGoToUserPublicShare,
        secretShare: bitGoToUserPrivateShare.slice(0, 64),
  ...
  async createBackupKeychain(
    ...
    const backupSigningMaterial: SigningMaterial = {
      userShare: {
        publicShare: userKeyShare.pub,
        secretShare: userKeyShare.secretShares[1],
        chaincode: userKeyShare.chaincode,
      },
      backupShare: {
        publicShare: backupKeyShare.pub,
        secretShare: backupKeyShare.secretShares[1],
        chaincode: backupKeyShare.chaincode,
        seed: backupKeyShare.seed,
      },
      bitgoShare: {
        publicShare: bitGoToBackupPublicShare,
        secretShare: bitGoToBackupPrivateShare.slice(0, 64),
